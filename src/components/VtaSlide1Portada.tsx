    ...
    <SlideWrapper className="bg-gradient-to-br from-[#F5A623] via-[#F7B500] to-[#F5A623]" hideFooter>
      <div className="flex-1 flex flex-col items-center justify-center text-center px-16">
        ...
        <p className="text-white/80 text-xl mb-10">
          Enero — Junio 2026 · Mi Tienda del Ahorro
        </p>

        <div className="bg-white/20 backdrop-blur-sm rounded-2xl px-10 py-6 border border-white/30">
          <p className="text-white/70 text-sm mb-1">Venta acumulada YTD (Ene–Jun)</p>
          <p className="text-white text-6xl font-bold">$4.67M</p>
          <p className="text-white/90 text-xl mt-2 font-semibold">+185.5% vs 2025 · +53.8% comparable</p>
        </div>

        <p className="text-white/60 text-sm mt-10">
          Delikos · KAM Sell-Out Report · Corte al 30 de Junio 2026
        </p>
      </div>
    </SlideWrapper>
  );
