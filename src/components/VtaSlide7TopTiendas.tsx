...
const topTiendas = [
  { nombre: "MT Mat Las Brisas", venta: 262744, pct: 6.8, crec: "+199.2%" },
  { nombre: "MT Rey Bugambilias", venta: 250477, pct: 6.5, crec: "+161.3%" },
  { nombre: "MT Rey Periférico", venta: 233216, pct: 6.1, crec: "+199.5%" },
  { nombre: "MT Nvo Reforma", venta: 201976, pct: 5.2, crec: "+229.7%" },
  { nombre: "MT Nvo Revolución", venta: 190353, pct: 4.9, crec: "+307.3%" },
  { nombre: "MT Rey San Fernando", venta: 186427, pct: 4.8, crec: "+127.4%" },
  { nombre: "MT Mty Zuazua", venta: 174635, pct: 4.5, crec: "+155.5%" },
  { nombre: "MT Rey Río Bravo", venta: 169419, pct: 4.4, crec: "+176.0%" },
  { nombre: "MT Mty García", venta: 158614, pct: 4.1, crec: "+234.2%" },
  { nombre: "MT Mty Ciudadela", venta: 154797, pct: 4.0, crec: "+180.3%" },
];

const bottomTiendas = [
  { nombre: "MT Valle Sta. María", venta: 85117 },
  { nombre: "MT Margaritas", venta: 77390 },
  { nombre: "MT 9115 (nueva)", venta: 74269 },
...
export default function VtaSlide7TopTiendas() {
  return (
    <SlideWrapper className="bg-[#F5F5F5] p-10">
      ...
      <p className="text-gray-500 text-sm mb-4">Ene-May 2026 · Top 10 concentra 51.4% de la venta</p>
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="text-center">
                ...
                <p className="text-[#F5A623] text-2xl font-bold">51.4%</p>
              </div>
              <div className="text-center">
